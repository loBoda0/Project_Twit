...
$("#replyModal").on("hiiden.bs.modal", () => $("#originalPostContainer").html(""))
...
$("#imageUploadButton").click(() => {
    ...
    if(canvas == null) {
        alert("Could not upload photo. Make sure it is an image file.");
        return;
    }
...
function refreshNotificationsBadge() {
    $.get("/api/notifications", { unreadOnly: true }, (data) => {
        ...
        if(numResults > 0) {
            ...
            $("#notificationsBadgeBadge").text("").removeClass("active");
        }
    })
}
...
function getNotificationText(notification) {
    ...
    if(notification.notificationType == "postReply") {
...
function getNotificationUrl(notification) {
    ...
    notification.notificationType == "postReply") {
